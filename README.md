...
- PTGER4–DINP membrane MD: 35 ns milestone QC recorded; 100 ns production continues locally (see [`outputs/md_ptger4_membrane_md/`](outputs/md_ptger4_membrane_md/)).
