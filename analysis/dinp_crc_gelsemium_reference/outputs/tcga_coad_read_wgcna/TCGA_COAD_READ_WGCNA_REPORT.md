...
- Soft-threshold power: **8** (first power with signed R² >= 0.80 and mean connectivity > 1).
...
- Network: signed bicor; power=8; minModuleSize=30; mergeCutHeight=0.25; deepSplit=2.
