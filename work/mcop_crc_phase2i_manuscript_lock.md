...
B. Environmental-chemical filtering and stability criteria.
C. Ranked screen highlighting MiNP/DINP axis while visually distinguishing known/crowded hits.
D. Translation step: MiNP/DINP molecular nomination -> MCOP as NHANES human DINP biomarker -> CRC complex-survey analysis.
